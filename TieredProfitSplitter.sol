...
contract TieredProfitSplitter {
    ...
    function deposit() public payable {
        ...
        //ceo Calculate and transfer the distribution percentage
        amount = points * 60;
        ...
        // Your code here!
        //cto Calculate and transfer the distribution percentage
        amount = points * 25;
        total += amount;
        employee_two.transfer(amount); 
        
         //bob Calculate and transfer the distribution percentage 
        amount = points * 15;
        total += amount;
